...
const EMD = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://54.196.55.108:3000/user/emd', formattedData);
  ...
  const handleViewAbstract = async () => {
    try {
      const result = await axios.get('http://54.196.55.108:3000/user/getAbstractData');
