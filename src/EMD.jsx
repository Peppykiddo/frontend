...
const EMD = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://35.175.186.111:3000/user/emd', formattedData);
  ...
  const handleViewAbstract = async () => {
    try {
      const result = await axios.get('http://35.175.186.111:3000/user/getAbstractData');
