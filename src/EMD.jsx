...
const EMD = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://107.20.36.191:3000/user/emd', formattedData);
  ...
  const handleViewAbstract = async () => {
    try {
      const result = await axios.get('http://107.20.36.191:3000/user/getAbstractData');
